//
//  TrendingCoursesCollectionViewCell.swift
//  GrappleSpace
//
...
class TrendingCoursesCollectionViewCell: UICollectionViewCell {
    
    static let identifier = "TrendingCoursesCollectionViewCell"
